...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_writterById_fkey" FOREIGN KEY ("writterById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
